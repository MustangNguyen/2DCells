...
public static class GameStatic
{
    ...
    public readonly static string GET_PLANETS_API = "/api/Planets/";
    public readonly static string GET_USER_NODE_PROCESS_API = "/api/Planets/";
    ...
    public readonly static string POST_UPDATE_USER_EQUIPMENT = "/api/UserEquipment/UpdateUserEquipment";
    #endregion
